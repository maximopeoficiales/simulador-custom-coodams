...
class ShortcodeController
{
    ...
    {
        wp_enqueue_style('chuck_css_react', assetStaticCSSReact('main.bf2a25a2.chunk.css'), '', '1.0.0');
        ...
        wp_enqueue_script('chuck_js_react_2', assetStaticJSReact('main.c24cecc6.chunk.js'), '', '1.0.0', true);
