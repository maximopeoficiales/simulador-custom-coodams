...
<form action="" method="post">
    ...
    <div class="form-group my-2">
        ...
        <input type="number" name="tasa_vivienda" id="tasa_vivienda" step="0.1" class="form-control"
            placeholder="Ejm: 1.1" value="<?php echo e(get_option('tasa_vivienda')); ?>">
    </div>
    ...
    <div class="form-group my-2">
        ...
        <input type="number" name="tasa_vehiculo_1" id="tasa_vehiculo_1" step="0.1" class="form-control"
            placeholder="Ejm: 1.1" value="<?php echo e(get_option('tasa_vehiculo_1')); ?>">
    </div>
    <div class="form-group my-2">
        ...
        <input type="number" name="tasa_vehiculo_2" id="tasa_vehiculo_2" step="0.1" class="form-control"
            placeholder="Ejm: 1.1" value="<?php echo e(get_option('tasa_vehiculo_2')); ?>">
    </div>
    ...
    <div class="form-group my-2">
        ...
        <input type="number" name="tasa_vehiculo_3" id="tasa_vehiculo_3" step="0.1" class="form-control"
            placeholder="Ejm: 1.1" value="<?php echo e(get_option('tasa_vehiculo_3')); ?>">
    </div>
    <div class="form-group my-2">
        ...
        <input type="number" name="monto_max_libre_inversion" id="monto_max_libre_inversion" class="form-control"
            placeholder="Ejm: 5269451" value="<?php echo e(get_option('monto_max_libre_inversion')); ?>">
    </div>
    <div class="form-group my-2">
        ...
        <input type="number" name="monto_max_vivienda" id="monto_max_vivienda" class="form-control"
            placeholder="Ejm: 181705200" value="<?php echo e(get_option('monto_max_vivienda')); ?>">
    </div>
    <div class="form-group my-2">
        ...
        <input type="number" name="monto_max_vehiculo" id="monto_max_vehiculo" class="form-control"
            placeholder="Ejm: 45426300" value="<?php echo e(get_option('monto_max_vehiculo')); ?>">
    </div>
